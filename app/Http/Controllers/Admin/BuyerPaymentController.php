...
class BuyerPaymentController extends Controller
{
    ...
    public function __construct(BuyerPaymentServiceInterface $service, BuyerServiceInterface $buyerService)
    {
        $this->service = $service;
        $this->buyerService = $buyerService;

        $config = new PageConfig("buyerPayment", 'admin.buyer-payment', "admin", "buyer-payment", [
            "create" => "admin.buyer-payment.create",
            "show" => "admin.buyer-payment.show",
        ]);
