...
use App\Http\Requests\Employee\SaleRequest\StoreSaleRequestRequest;
...
class SaleRequestController extends Controller
{
    ...
    public function __construct(SaleRequestServiceInterface $service, PropertyServiceInterface $propertyService)
    {
        ...
        $config = new PageConfig("saleRequest", 'employee.sale-request', "employee", "sale-request", [
            "create" => "employee.sale-request.create",
        ]);
