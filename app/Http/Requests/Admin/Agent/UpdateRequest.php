...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'username' => ['required', 'string', 'max:100', Rule::unique('employees', 'username')->ignore($agentId)],
            'email' => ['required', 'email', 'max:255', Rule::unique('employees', 'email')->ignore($agentId)],
            'phone' => ['nullable', 'string', 'max:20', Rule::unique('employees', 'phone')->ignore($agentId), 'phone:INTERNATIONAL,BD'],
