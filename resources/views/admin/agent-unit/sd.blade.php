<x-app-layout>
        ...
        <div class="card">
            <header class=" card-header noborder">
                <div class="justify-end flex gap-3 items-center flex-wrap">
                    ...
                    <a class="btn inline-flex justify-center btn-dark rounded-[25px] items-center !p-2.5" href="{{ route($pageConfig->routes->verified) }}">
    ...
    <!-- Modal Area Start -->
    <div id="property_deposit_mdl" tabindex="-1" aria-labelledby="property_deposit_mdl" class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto">
                            ...
                            <form id="verify_form">
                                ...
                                <div class="p-6 space-y-6">
                                    <div class="input-group">
                                        <label for="date" class="text-sm font-Inter font-normal text-slate-900 block">Property Security Deposited Date:</label>
                                        <input type="date" id="date" name="date" value="0" class="text-sm font-Inter font-normal text-slate-600 block w-full py-3 px-4 focus:!outline-none focus:!ring-0 border
                                                !border-slate-400 rounded-md mt-2" placeholder="deposit date">
                                    </div>
    ...
    @include( $pageConfig->view_root . ".sd-scripts")
</x-app-layout>
