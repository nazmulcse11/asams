                        ...
                        <div class="grid sm:grid-cols-1 gap-x-8 gap-y-4 mt-6">
                            ...
                            <div class="input-area">
                                ...
                                <input name="first_name" type="text" id="first_name" class="form-control"
                                       placeholder="{{ __('Enter first name') }}" value="{{ old('first_name') }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <input name="picture" type="file" id="picture" class="form-control"
                                       placeholder="{{ __('Enter profile picture URL') }}" value="{{ old('picture') }}">
                            ...
                            <div class="input-area">
                                ...
                                <select name="blood_group" id="bloodGroupDropdown" class="form-control" data-old="{{ old('blood_group') }}"></select>
                            ...
                            <div class="input-area">
                                ...
                                <input name="nid" type="text" id="nid" class="form-control"
                                       placeholder="{{ __('Enter NID') }}" value="{{ old('nid') }}">
                            ...
                            <div class="input-area">
                                ...
                                <select name="gender" id="genderDropdown" class="form-control" data-old="{{ old('gender') }}"></select>
                            ...
                            <div class="input-area">
                                ...
                                <select name="marital_status" id="maritalDropdown" class="form-control" data-old="{{ old('marital_status') }}"></select>
                        ...
                        <div class="grid sm:grid-cols-1 gap-x-8 gap-y-4 mt-6">
                            ...
                            <div class="input-area">
                                ...
                                <input name="username" type="text" id="username" class="form-control"
                                       placeholder="{{ __('Enter employee username') }}" value="{{ old('username') }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <input name="phone" type="text" id="phone" class="form-control"
                                       placeholder="{{ __('Enter employee phone') }}" value="{{ old('phone') }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <select name="status" class="form-control" id="generalStatusDropdown" data-old="{{ old('status') }}"></select>
