<x-app-layout>
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
        <div class="agent-profile-sidebar ">
            ...
            <div class="prifile-content p-4 xl:p-10 bg-white rounded-2xl xl:pt-[130px] border border-slate-100">
                ...
                <div class="footer mt-6 flex items-center justify-between">
                        ...
                        <div class="card-inner w-full h-full transform-preserve-3d transition-transform duration-700 *:absolute *:w-full *:h-full shadow-md">
                            ...
                            @isset($item->profile?->nid_copy)
                                <div class="card front overflow-hidden">
                                    <img src="{{ $item->profile?->nid_copy }}" class="frontpart w-full h-full object-cover object-center" alt="NID Front of {{ $item->profile?->full_name }}">
                                </div>
                                <div class="card back overflow-hidden">
                                    <img src="{{ $item->profile?->nid_copy }}" class="backpart w-full h-full object-cover object-center" alt="NID Back of {{ $item->profile?->full_name }}">
                                </div>
                            @endisset
                    ...
                    <img src="@qr(route('admin.agent.show', $item->id))" class="border border-slate-100 rounded-xl w-[80px] max-lg:hidden" alt="{{ __('James Milner')}}">
        ...
        <div class="agent-profile-timeline xl:col-span-2">
            <div class="states grid gap-4 xl:gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 2xl:grid-cols-3 mb-6">
                ...
                <div class="card shadow-md p-4 rounded-xl flex gap-5">
                    ...
                    <div class="info">
                        <p>Shop Sold</p>
                        <h6 class="font-semibold text-pureblack text-2xl">{{ $sold }}</h6>
                    </div>
                </div>
                ...
                <div class="card shadow-md p-4 rounded-xl flex gap-5">
                    ...
                    <div class="info">
                        <p>Revenue Via</p>
                        <h6 class="font-semibold text-pureblack text-2xl">{{ $revenue }}</h6>
                    </div>
                </div>
                ...
                <div class="card shadow-md p-4 rounded-xl flex gap-5">
                    ...
                    <div class="info">
                        <p>Commission</p>
                        <h6 class="font-semibold text-pureblack text-2xl">{{ $commission }}</h6>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                ...
                @foreach($shops as $shop)
                    <div class="block-item rounded-2xl overflow-hidden border border-slate-100 bg-white">
                        ...
                        <div class="p-6">
                            <img   src="@if(isset($shop->picture[0])) {{ asset($shop->picture[0]) }} @else {{ asset('/images/pic1.png') }} @endif" alt="Property Image" class="w-full object-cover rounded-lg">
                            ...
                            <ul class="flex items-center gap-3 justify-between my-6">
                                <li>
                                    {{ __("Area: ")}}<b>{{ $shop->total_area }}</b>
                                </li>
                                <li>
                            ...
                            <div class="clear-both">
                                <p class="text-sm text-gray-500">
                                    <img style="max-width: 100px; height: 100px;" src="@qr(route('admin.shop.show', $shop->id))" class="float-right ml-2 mb-2 border border-slate-100 p-2 rounded-lg" alt="">
                                    <span class="line-clamp-4">
                                    {{ $shop->description }}
                                </span>
                                </p>
                            </div>
                            <div class="mt-10 flex gap-3 *:text-sm *:py-3.5 *:rounded-md *:font-semibold *:flex-1 *:inline-flex *:items-center *:justify-center *:transition-all">
                                <a href="#shop_details_modal" data-popup="modal" data-shop-id="{{ $shop->id }}" class="shop-details-modal text-themered bg-[#FFF0F1] hover:bg-themered hover:text-white">
