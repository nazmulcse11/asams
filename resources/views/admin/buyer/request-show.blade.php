                        ...
                        <table class="table w-full border-separate [&_td]:py-3 [&_td]:border-b [&_td]:border-b-slate-100 [&_td]:align-middle [&_td:first-child]:whitespace-nowrap">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-gunmetal font-semibold">
                                        {{ __('50,00,000 – 1,20,00,000') }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-ash">
                                        {{ __("Timeline to Close Deal :")}}
                                    </td>
                                    <td class="text-gunmetal font-semibold">
                                        {{ __('30 - 90 Days') }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-gunmetal font-semibold">
                                        {{ __('I’m an entrepreneur currently expanding my retail network across Dhaka’s busiest commercial zones. I actively seek well-located, high-footfall shops for long-term investment and brand placement. ') }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
