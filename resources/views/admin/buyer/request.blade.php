            ...
            <div class="buyer sm:flex gap-4 rounded-xl overflow-hidden border border-slate-100 bg-white p-4 lg:p-6">
                ...
                <div class="info sm:flex-1 p-4">
                    ...
                    <div class="mt-5 flex justify-between gap-3 *:flex *:items-center *:justify-center *:gap-2 *:flex-1 *:rounded-lg *:px-6 *:py-3 *:transition-all">
                        <a href="#" class="bg-[#FFF0F1] text-themered hover:bg-themered hover:text-white">
                            {{ __('Reject') }}
                        </a>
                        <a href="#" class="bg-themered text-white hover:bg-gunmetal">
                            {{ __('Approve') }}
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16 3.66525C14.7878 3.07907 13.4304 2.75 12 2.75C6.9125 2.75 2.75 6.9125 2.75 12C2.75 17.0875 6.9125 21.25 12 21.25C17.0875 21.25 21.25 17.0875 21.25 12C21.25 11.3139 21.1743 10.6445 21.0308 10" stroke="#FFF0F1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M7.5 11.998L10.25 14.748L21.25 3.74805" stroke="#FFF5F5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </a>
                    </div>
                </div>
