                    ...
                    <div class="right">
                        <div class="input-area max-sm:flex-[50%] sm:flex-[0_0_200px] space-y-1">
                            ...
                            <select class="w-full px-4 py-3 text-sm rounded-lg bg-white border border-[#E1E5EA] *:dark:bg-slate-700 focus:outline-0 cursor-pointer">
                                <option value="">{{ __('Bought Shops')}}</option>
                                <option value="">{{ __('Lease Shops')}}</option>
                        ...
                        <div class="p-6">
                            ...
                            <div class="clear-both">
                                <p class="text-sm text-gray-500">
                                    <img style="max-width: 100px; height: 100px;" src="@qr(route('admin.shop.show', $shop->id))" class="float-right ml-2 mb-2 border border-slate-100 rounded-lg" alt="">
