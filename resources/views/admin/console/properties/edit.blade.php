                    ...
                    <div class="form-body grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-10">
                        ...
                        @if($init->img_video)
                            <div class="field-item space-y-2">
                                ...
                                <input type="file" inputmode="numeric" name="images" id="images" class="w-full border border-gray-300 rounded-lg p-2 bg-white file:mr-4 file:p-2 file:rounded-lg file:border-0 file:bg-red-600 file:text-white"/>
