        ...
        <div class="thumb_meta grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div class="thumb lg:col-span-2">
                @isset($item->picture[0])
                    <img src="{{ $item->picture[0] }}" alt="Property Image" class="w-full max-h-[420px] object-cover rounded-xl">
                @else
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div class="shop_info lg:col-span-2 space-y-6">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="qr flex-[0_0_70px] border rounded-lg border-gray-200 overflow-hidden">
                ...
                @if($item->agentUnit && $item->agentUnit->count() > 0)
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full border-collapse">
                            ...
                            <tbody>
                            @foreach($item->agentUnit as $agent)
                                <tr class="*:text-black-500 *:font-medium *:py-2 *:px-4 *:text-sm *:text-center *:border *:border-slate-100">
                                    ...
                                    <td>
                                        {{ $agent->booking_percent }}
                                    </td>
                                    <td>
                                        {{ $agent->booking_amount }}
                                    </td>
