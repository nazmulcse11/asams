                                    ...
                                    <tr class="border border-slate-100 dark:border-slate-900 relative">
                                        ...
                                        <td class="table-td">
                                            <div class="action-btns space-x-2 flex">
                                                {{-- show --}}
                                                    <a class="action-btn" href="{{ route('admin.console.role.admin.show', $role->id) }}" x-data="{ tooltip: 'View' }" x-tooltip="tooltip">
                                                        <iconify-icon icon="ph:eye-light"></iconify-icon>
                                                    </a>
                                                {{-- delete --}}
                                                    <form id="deleteForm{{ $role->id }}" method="POST" action="{{ route('admin.console.role.admin.destroy', $role->id) }}" class="cursor-pointer">
                                                        @csrf
                                                        @method('DELETE')
