        ...
        <div class="card">
            <header class=" card-header noborder">
                <div class="justify-end flex gap-3 items-center flex-wrap">
                    <a class="btn inline-flex justify-center btn-dark rounded-[25px] items-center !p-2 !px-3" href="{{ route('admin.console.user.employee.create') }}">
                                ...
                                <tr>
                                    ...
                                    <td class="table-td">
                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                            ...
                                            <a class="action-btn" href="{{ route("admin.console.user.employee.show", $item->id ?? "") }}">
                                                <iconify-icon icon="heroicons:eye"></iconify-icon>
                                            </a>

                                            <a class="action-btn" href="{{ route("admin.console.user.employee.edit", $item->id ?? "") }}">
                                                <iconify-icon icon="heroicons:pencil-square"></iconify-icon>
                                            </a>

                                            <form id="deleteForm2" method="POST" action="{{ route("admin.console.user.employee.destroy", $item->id ?? "") }}">
                                                @csrf
