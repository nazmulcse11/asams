                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-md p-5 pb-6">
                        <div class="grid sm:grid-cols-1 gap-x-8 gap-y-4 mt-6">
                            ...
                            <div class="input-area">
                                ...
                                <textarea name="address" id="address" cols="30" rows="10" class="form-control" placeholder="write address">{{ old('address', $item->address) }}</textarea>
                            ...
                            <div class="input-area">
                                ...
                                <input name="contact_person" type="text" id="contact_person" class="form-control"
                                       placeholder="{{ __('Enter contact person') }}" value="{{ old('contact_person', $item->contact_person) }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <input name="contact_number" type="text" id="contact_number" class="form-control"
                                       placeholder="{{ __('Enter contact number') }}" value="{{ old('contact_number', $item->contact_number) }}" required>
                            ...
                            <div class="flex mb-4">
                                <div class="input-area">
                                    ...
                                    <input name="latitude" type="number" id="latitude" class="form-control" step="0.000001" min="-90" max="90"
                                           placeholder="{{ __('Enter latitude') }}" value="{{ old('latitude',     $item->latitude) }}" required>
                                ...
                                <div class="input-area">
                                    ...
                                    <input name="longitude" type="number" id="longitude" class="form-control" step="0.000001" min="-180" max="180"
                                           placeholder="{{ __('Enter longitude') }}" value="{{ old('longitude',     $item->longitude) }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <select name="property_type_id" class="form-control" id="propertyTypeDropdown" data-old="{{ old('property_type_id', $item->property_type_id) }}"></select>
