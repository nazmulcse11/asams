<x-app-layout>
    ...
    <div class="chart_cards grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5">
                <div id="commission_earning_chart"></div>
            </div>
        </div>
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5">
                <div id="agent_performance_chart"></div>
            </div>
        </div>
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5">
                <div id="buyer_request_chart"></div>
            </div>
        </div>
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5">
                <div id="activity_log_report"></div>
            </div>
        </div>
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5">
                <div class="max-w-56 lg:max-w-80 mx-auto">
                    <canvas id="occupied_vacant_chart"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5">
                <div id="property_distribution_chart"></div>
            </div>
        </div>
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5 flex items-center justify-center max-sm:flex-col sm:flex-row-reverse gap-10">
                <div class="max-w-56 lg:max-w-80">
                    <canvas id="installment_payment_chart" ></canvas>
                </div>
                <div id="installment_payment_legend"></div>
            </div>
        </div>
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5 flex items-center justify-center max-sm:flex-col gap-10">
                <div class="max-w-56 lg:max-w-80">
                    <canvas id="withdrawal_report_chart"></canvas>
                </div>
                <div id="withdrawal_report_legend"></div>
            </div>
        </div>
        
    </div>

   @include("admin.report.charts")
