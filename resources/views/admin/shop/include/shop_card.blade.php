    ...
    <div class="">
        ...
        <div class="p-3 xl:p-4">
            <div class="flex items-center justify-between gap-4 flex-wrap">
                ...
                <span class="inline-flex bg-green-100 text-green-600 text-sm px-5 py-2 rounded-3xl">
                    {{ $shop?->status?->name }}
                </span>
            </div>
            ...
            <div class="clearfix">
                <p class="text-sm text-gray-500">
                    <img src="@qr(route('admin.shop.show', $shop->id))" class="w-[80px] float-right ml-2 mb-2 border border-slate-100 rounded-lg" alt="{{ $shop->number }}">
