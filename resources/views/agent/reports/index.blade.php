    ...
    <div class="chart_cards grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5 flex items-center justify-center max-sm:flex-col gap-10">
                <div class="max-w-56 lg:max-w-80">
                    <canvas id="agent_withdrawal_report_chart"></canvas>
                </div>
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5">
                <div id="agent_agreement_summery"></div>
            </div>
        </div>
        ...
        <div class="card-item bg-white rounded-2xl border border-slate-100">
            ...
            <div class="card-body py-5">
                <div id="agent_commission_earning_chart"></div>
            </div>
        </div>
