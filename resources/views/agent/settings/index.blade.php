    ...
    <div class="tab-wrapper max-w-screen-lg mx-auto bg-white rounded-2xl border border-slate-100 overflow-hidden sm:flex">
        <div class="flex-[0_0_240px] border-r border-slate-100 py-4 px-3">
            ...
            <ul class="nav-tabs space-y-1 [&_a]:w-full [&_a]:py-2.5 [&_a]:px-3 [&_a]:rounded-md [&_a]:font-medium [&_a]:inline-flex [&_a]:items-center [&_a]:gap-2 [&_a]:text-base [&_a]:transition-all [&_a]:text-[#607085]">
                ...
                <li>
                    <a href="#payout_settings" class="@if(request()->query('tab') == 'payout_settings') active @endif nav-item hover:bg-[#FFF5F5] hover:text-themered [&.active]:bg-[#FFF5F5] [&.active]:text-themered">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="tab-content flex-1 *:p-4 xl:*:p-10 xl:*:py-8">
            <div class="tab-pane fade @if(request()->query('tab') == 'profile_settings') active show @endif active show" id="profile_settings">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="field-body grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="field-item space-y-1">
                            <label class="text-gunmetal font-medium block text-sm">
                                {{ __('Agency/Company Name')}}<span class="text-xs text-[#8997A9]">(if any)</span> <span class="text-red-600">*</span>
                            </label>
                            <input type="email" name="agency_name" value="" placeholder="{{ __('your affiliated agency')}}" class="w-full text-sm py-[13px] px-4 bg-white border rounded-lg" required />
                            <x-input-error :messages="$errors->get('agency_name')" class="mt-1"/>
                        </div>

                        <div class="field-item space-y-1">
                            <label class="text-gunmetal font-medium block text-sm">
                                {{ __('Designation')}} <span class="text-red-600">*</span>
                            </label>
                            <select name="designation" class="w-full text-sm font-light py-3 px-4 bg-white border rounded-lg" required >
            ...
            <div class="tab-pane fade @if(request()->query('tab') == 'payout_settings') active show @endif" id="payout_settings">
                <h6 class="font-medium text-black-500 text-xl mb-4 border-b border-slate-100 pb-2">
                    {{ __("Payout Settings") }}
                </h6>
                <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <tbody>
                                <tr class="*:py-5 *:px-4 *:border-b *:whitespace-nowrap">
                                    <td class="text-pureblack font-medium text-sm">
                                        {{ __("New Buyer Inquiry")}}
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" name="enable__newBuyerinquery__email" id="enable__newBuyerinquery__email" class="peer sr-only">
                                        <label for="enable__newBuyerinquery__email" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="enable__newBuyerinquery__sms" id="enable__newBuyerinquery__sms" class="peer sr-only">
                                        <label for="enable__newBuyerinquery__sms" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="enable__newBuyerinquery__push" id="enable__newBuyerinquery__push" class="peer sr-only">
                                        <label for="enable__newBuyerinquery__push" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                ...
                                <tr class="*:py-5 *:px-4 *:border-b *:whitespace-nowrap">
                                    <td class="text-pureblack font-medium text-sm">
                                        {{ __("Reservation Approved")}}
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" name="reservation_approved__email" id="reservation_approved__email" class="peer sr-only">
                                        <label for="reservation_approved__email" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="reservation_approved__sms" id="reservation_approved__sms" class="peer sr-only">
                                        <label for="reservation_approved__sms" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="reservation_approved__push" id="reservation_approved__push" class="peer sr-only">
                                        <label for="reservation_approved__push" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                ...
                                <tr class="*:py-5 *:px-4 *:border-b *:whitespace-nowrap">
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="withdrawal__process__email" id="withdrawal__process__email" class="peer sr-only">
                                        <label for="withdrawal__process__email" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="withdrawal__process__sms" id="withdrawal__process__sms" class="peer sr-only">
                                        <label for="withdrawal__process__sms" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="withdrawal__process__push" id="withdrawal__process__push" class="peer sr-only">
                                        <label for="withdrawal__process__push" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                ...
                                <tr class="*:py-5 *:px-4 *:border-b *:whitespace-nowrap">
                                    <td class="text-pureblack font-medium text-sm">
                                        {{ __("Admin Message/Notice")}}
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" name="admin_message__email" id="admin_message__email" class="peer sr-only">
                                        <label for="admin_message__email" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="admin_message__sms" id="admin_message__sms" class="peer sr-only">
                                        <label for="admin_message__sms" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="admin_message__push" id="admin_message__push" class="peer sr-only">
                                        <label for="admin_message__push" class="w-5 h-5 rounded border border-slate-300 inline-flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 cursor-pointer">
                                            <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.125 8.125L11 1.25" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </label>
