<x-website-layout>
    <div class="authentication pt-40 pb-20 md:pt-52 md:pb-24 xl:pt-64 xl:pb-44 bg-cover bg-bottom" style="background-image: url({{ asset('/images/website/authentication-bg.png') }});">
        <div class="container">
            ...
            <form method="POST" action="{{ route('agent.password.email') }}" class="bg-white shadow-xl rounded-2xl xl:rounded-3xl p-6 sm:p-10 lg:p-14 max-w-xl mx-auto">
                ...
                <div class="form-body space-y-5 my-10">
                    <div class="field-item space-y-2">
                        ...
                        <input type="text" name="email" id="email" placeholder="agent@asams.com" class="w-full" value="{{ old('email') }}">
