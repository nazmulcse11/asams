    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
        <div class="agent-profile-sidebar ">
            <div class="profile-image -mb-[120px]">
                <img src="{{ asset('/images/buyer/1.png') }}" class="w-60 h-60 rounded-full border border-slate-50 mx-auto" alt="{{ $item->profile?->first_name ?? 'N/A' }}">
            </div>
            <div class="profile-content p-4 xl:py-10 xl:px-6 3xl:px-10 bg-white rounded-2xl xl:pt-[130px] border border-slate-100">
                ...
                <p class="text-center my-2">
                    <span class="inline-block px-4 py-2 rounded-2xl bg-slate-100 text-black-600 text-sm">
                        {{ __("Since : ") }} {{ __('June 2021')}}
                    </span>
                </p>
                <p class="text-center font-semibold text-gunmetal mb-6">
                    ID : AGT-2987
                </p>
                ...
                <div class="footer mt-6 flex items-center justify-between">
                    <div class="nid w-[270px] h-[170px] relative ">
                        <div class="card-inner w-full h-full transform-preserve-3d transition-transform duration-700 *:absolute *:w-full *:h-full shadow-md">
                            ...
                            <div class="card front overflow-hidden">
                                <img src="{{ asset('/images/buyer/nid.png') }}" class="frontpart w-full h-full object-cover object-center" alt="NID Front of {{ $item->profile?->full_name }}">
                            </div>
                            <div class="card back overflow-hidden">
                                <img src="{{ asset('/images/buyer/nid.png') }}" class="backpart w-full h-full object-cover object-center" alt="NID Back of {{ $item->profile?->full_name }}">
                            </div>
                            
                        </div>
                    </div>

                    <img src="" class="border border-slate-100 rounded-xl w-[80px] max-lg:hidden" alt="{{ __('James Milner')}}">

                </div>
            </div>
        </div>
        <div class="agent-profile-timeline xl:col-span-2">
                ...
                <div class="flex flex-wrap items-end justify-between gap-6">
                    <div class="left">
                        <div class="input-area relative">
                            <input type="text" name="s" class="w-full px-4 py-3 !pl-9 rounded-lg bg-white focus:outline-none" placeholder="Search">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 items-start">
                ...
                <div id="shop-card-1" class="shop-item bg-white rounded-2xl overflow-hidden border border-slate-100">
                    <div class="thumbnail relative">
                        <a href="{{ route('employee.agent-shop-details') }}">
                    ...
                    <div class="space-y-5 px-4 py-5 xl:px-6">
                        ...
                        <div class="finance_states overflow-x-auto">
                            <table class="w-full border border-slate-200 rounded-xl border-collapse table-auto">
                                <tbody>
                                    <tr class="*:bg-[#F8F9FB] *:border *:border-slate-200 *:px-4 *:py-1.5 *:text-center *:text-xs *:leading-4 *:whitespace-nowrap">
                                        <td>
                                            Sale Price <br>
                        ...
                        <div class="!mt-6 flex gap-2 *:text-sm *:py-2 *:rounded-md *:font-semibold *:flex-1 *:inline-flex *:items-center *:justify-center *:transition-all">
                            <a href="{{ route('employee.agent-shop-details') }}" data-shop-id="1" class="shop-details-1 text-themered bg-[#FFF0F1] hover:bg-themered hover:text-white">
                                <iconify-icon class="text-xl ltr:mr-2 rtl:ml-2 font-light" icon="heroicons-outline:eye"></iconify-icon>
                                Shop Details
                            </a>
                            <a href="#" data-shop-id="1" data-popup="modal" class="shop-details-modal text-gunmetal border border-slate-200 hover:bg-gunmetal hover:text-white">
                                <iconify-icon icon="solar:document-linear" class="text-xl ltr:mr-2 rtl:ml-2 font-light"></iconify-icon>
                                Proposal Details
                            </a>
                        </div>                                
                    </div>
                 ...
                 <div id="shop-card-2" class="shop-item bg-white rounded-2xl overflow-hidden border border-slate-100">
                    ...
                    <div class="space-y-5 px-4 py-5 xl:px-6">
                        ...
                        <div class="finance_states overflow-x-auto">
                            <table class="w-full border border-slate-200 rounded-xl border-collapse table-auto">
                                <tbody>
                                    <tr class="*:bg-[#F8F9FB] *:border *:border-slate-200 *:px-4 *:py-1.5 *:text-xs *:text-center *:leading-4 *:whitespace-nowrap">
                                        <td>
                                            Sale Price <br>
                                            <b class="text-pureblack">৳3,50,000</b> 
                                        </td>
