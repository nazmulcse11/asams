                ...
                <div id="shop-card-1" class="shop-item bg-white rounded-2xl overflow-hidden border border-slate-100">
                    ...
                    <div class="space-y-5 px-4 py-5 xl:px-6">
                        ...
                        <div class="!mt-6 flex gap-2 *:text-sm *:py-2 *:rounded-md *:font-semibold *:flex-1 *:inline-flex *:items-center *:justify-center *:transition-all">
                            <a href="{{ route('employee.buyer-shop-details') }}" data-shop-id="1" class="shop-detail text-themered bg-[#FFF0F1] hover:bg-themered hover:text-white">
                                <iconify-icon class="text-xl ltr:mr-2 rtl:ml-2 font-light" icon="heroicons-outline:eye"></iconify-icon>
                                Shop Details
                            </a>
                            <a href="#" data-shop-id="1"  class="text-gunmetal border border-slate-200 hover:bg-gunmetal hover:text-white">
                ...
                <div id="shop-card-2" class="shop-item bg-white rounded-2xl overflow-hidden border border-slate-100">
                    ...
                    <div class="space-y-5 px-4 py-5 xl:px-6">
                        <div class="flex items-center justify-between gap-4 flex-wrap">
                            <h5 class="text-lg">
                                <span class="text-gray-500">
                                    {{ __("Shop No.")}} <b class="font-bold text-black-500 text-2xl">102</b>
                                </span>
                            </h5>
                        ...
                        <div class="!mt-6 flex gap-2 *:text-sm *:py-2 *:rounded-md *:font-semibold *:flex-1 *:inline-flex *:items-center *:justify-center *:transition-all">
                            <a href="{{ route('employee.buyer-shop-details') }}" data-shop-id="1" class="shop-details text-themered bg-[#FFF0F1] hover:bg-themered hover:text-white">
                                <iconify-icon class="text-xl ltr:mr-2 rtl:ml-2 font-light" icon="heroicons-outline:eye"></iconify-icon>
                                Shop Details
                            </a>
                        </div>                                
