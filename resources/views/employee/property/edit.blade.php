                        ...
                        <div class="grid sm:grid-cols-1 gap-x-8 gap-y-4 mt-6">
                            ...
                            <div class="input-area">
                                ...
                                <input name="code" type="text" id="code" class="form-control" maxlength="1"
                                       placeholder="{{ __('Enter shop code') }}" value="{{ old('code', $item->code) }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <input name="name" type="text" id="name" class="form-control"
                                       placeholder="{{ __('Enter number') }}" value="{{ old('name', $item->name) }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="write description">{{ old('description', $item->description) }}</textarea>
                            ...
                            <div class="input-area">
                                ...
                                <input name="sell_price" type="text" id="sell_price" class="form-control"
                                       placeholder="{{ __('Enter sell price') }}" value="{{ old('sell_price', $item->sell_price) }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <input name="area" type="number" id="area" class="form-control"
                                       placeholder="{{ __('Enter area') }}" value="{{ old('area', $item->area) }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <input name="length" type="number" id="length" class="form-control"
                                       placeholder="{{ __('Enter length') }}" value="{{ old('length', $item->length) }}" required>
                            ...
                            <div class="input-area">
                                ...
                                <input name="wide" type="number" id="wide" class="form-control"
                                       placeholder="{{ __('Enter wide') }}" value="{{ old('wide', $item->wide) }}" required>
                                <x-input-error :messages="$errors->get('wide')" class="mt-2"/>
                            </div>

                            <div class="input-area">
                                <label for="floorDropdown" class="form-label">{{ __('Floor') }}</label>
                                <select name="floor_id" class="form-control" id="floorDropdown" data-old="{{ old('floor_id', $item->block?->floor?->id) }}"></select>
                                <x-input-error :messages="$errors->get('floor_id')" class="mt-2"/>
                            </div>

                            <div class="input-area">
                                <label for="blockDropdown" class="form-label">{{ __('Block') }}</label>
                                <select name="block_id" class="form-control" id="blockDropdown" data-old="{{ old('block_id', $item->block_id) }}"></select>
                            ...
                            <div class="input-area">
                                ...
                                <select name="status_id" class="form-control" id="generalStatusDropdown" data-old="{{ old('status_id', $item->status_id) }}"></select>
                                    ...
                                    @foreach($item->features as $index => $feature)
                                        <div class="feature-row mb-3 d-flex">
                                            <input type="text" class="form-control me-2" name="feature_name[]"
                                                   placeholder="Feature Name" value="{{ $feature->feature_name }}">
                                            <br>
                                            <input type="text" class="form-control me-2" name="feature_value[]"
                                                   placeholder="Value" value="{{ $feature->feature_value }}">
